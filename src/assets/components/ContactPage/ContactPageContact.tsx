  ...
  return(
    <section>
      <div id="contactPageContact" className="flex flex-col px-6 py-8 gap-10 bg-gray-100 dark:bg-gray-900 relative md:px-10 md:py-16 xl:px-20 bg-repeat bg-center">
        ...
        {/* Bottom */}
        <div className="absolute bottom-0 left-0 h-96 z-0 w-full bg-gradient-to-t from-sky-500 dark:from-pink-950 to-transparent opacity-40"
        ></div>
        {/* Decorative Divs ^ */}
        ...
        <div className="z-10 flex flex-col items-center gap-10 xl:flex-row xl:justify-center xl:items-stretch">
          ...
          <div className="relative bg-gray-100 dark:bg-gray-950 bg-opacity-50 dark:bg-opacity-60 overflow-hidden w-full rounded-lg max-w-sm md:max-w-lg xl:max-w-xl hover:bg-opacity-80 dark:hover:bg-opacity-80 transition-all duration-500 shadow-sm shadow-gray-600 dark:shadow-gray-950 xl:my-14">
