  ...
  return(
    <section>
      <div className="lg:flex lg:flex-row-reverse">
        ...
        <div className="lg:flex-1 relative bg-gray-800">
          {/* Decorative Divs */}
          {/* Top */}
          <div className="invisible absolute top-12 bottom-12 h-auto mx-6 z-0 w-10/12 bg-gradient-to-r from-sky-950 to-transparent md:visible xl:left-10"
          ></div>
        {/* Decorative Divs ^ */}
          
          <div className="relative px-6 pt-8 z-10 flex flex-col gap-4 md:px-10 md:pt-16 xl:px-20">
            <span className="uppercase text-start text-sm text-gray-100 font-bold lg:text-base">Who We Are</span>
            <h2 className="text-4xl text-left text-gray-100 font-bold lg:text-5xl">Your Go-To Partners for Anything IT</h2>
          </div>
